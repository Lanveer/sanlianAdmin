	...
	<div class="content">
		<form action="alipayapi.php" class="alipayform" method="post" target="_blank">
			...
			<div class="element">
				...
				<div class="einput"><input type="text" name="WIDbatch_no" id="WIDbatch_no" value="201651900001"></div>
				<br>
            ...
            <div class="element">
                ...
                <div class="einput"><input type="text" name="WIDdetail_data" value="2016051221001004940203432139^0.01^协商退款"></div>
                <br>

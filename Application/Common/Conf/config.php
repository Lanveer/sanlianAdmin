...
return array(
	...
	'LOAD_EXT_FILE' =>  'common,pay',   //自动加载Common目录下载PHP文件
...
//    'SESSION_OPTIONS'       =>  array(), // session 配置数组 支持type name id path expire domain 等参数
	...
	//Redis 缓存设置
	'DATA_CHACHE_PREFIX'    =>  '', //缓存前缀
	'DATA_CACHE_TYPE'  =>  "Redis",    //动态缓存为Redis
	'REDIS_RW_SEPARATE' =>  false,  //Redis读写分离
	'REDIS_HOST'    =>  'localhost',    //redis服务器IP,多台用逗号隔开
	'REDIS_PORT'    =>  '6379',
	'REDIS_TIMEOUT' =>   '300',//超时时间
	'REDIS_PERSISTENT'  =>  false,//是否长连接 false=短连接
	'REDIS_AUTH'    =>  'sl123456',//AUTH认证密码
	'DATA_CACHE_TIME'   =>  86400,      // 数据缓存有效期 0表示永久缓存


	'__ENCRYPT__'		=>'xbcrm',//加密字符串

	"HOST" => 'http://'.(isset($_SERVER['HTTP_X_FORWARDED_HOST']) ? $_SERVER['HTTP_X_FORWARDED_HOST'] : $_SERVER['HTTP_HOST']).__ROOT__."/",

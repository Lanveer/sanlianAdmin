...
$(function(){
	...
	$("#Hui-skin .dropDown-menu a").click(function(){
		...
		setCookie("Huiskin", v);
		$("#skin").attr("href","http://139.196.230.218/admin/Public/Admin/skin/"+v+"/skin.css");
		$(window.frames.document).contents().find("#skin").attr("href","http://139.196.230.218/admin/Public/Admin/skin/"+v+"/skin.css");
	});
}); 
